...
export class Backend implements backendInterface {
    ...
    async getReservation(arg0: ReservationId): Promise<Reservation> {
        if (this.processError) {
            try {
    ...
    async submitOrder(arg0: Order): Promise<OrderId> {
        if (this.processError) {
            try {
    ...
    async submitReservation(arg0: Reservation): Promise<ReservationId> {
        if (this.processError) {
            try {
